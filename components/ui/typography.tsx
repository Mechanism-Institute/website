...
const typographyVariants = cva("", {
  variants: {
    variant: {
      ...
      title2: "text-[32px] leading-full font-medium text-gray-900",
      subtitle: "text-[24px] leading-full font-normal text-gray-900",
      subtitle2: "text-[16px] leading-full font-medium text-gray-900",
